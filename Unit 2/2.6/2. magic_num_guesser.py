...
Description: Users guess a randomly selected number between 1 and 1000 with feedback from the bot on every guess.
"""
...
def main():
    ...
    while True:
        ...
        while True:
            ...
            # Display whether user input is too high or too low, if if its the same as computer selection.
            if user_feedback == 1:
                ...
                user_game_input = input("Excellent! You guessed the number! Would you like to play again (y or n)?: ")
                
                if user_game_input == "y":
                    repeat_status = 0
                    break
